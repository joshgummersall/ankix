...
var helpBindings = [][2]string{
	...
	{"h / l (visual)", "grow selection left / right"},
	{"H / L (visual)", "shrink selection left / right"},
	{"j / k (visual)", "grow selection down / up a line"},
	{"J / K (visual)", "shrink selection down / up a line"},
	...
	{"h / l (expand)", "grow phrase left / right"},
	{"H / L (expand)", "shrink phrase left / right"},
	{"esc", "cancel / back out"},
	{"?", "toggle this help"},
	{"q, ctrl+c", "quit"},
}
